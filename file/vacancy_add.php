                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <select name="eth" class="form-select form-select">
                                <option value="ເຜົ່າລາວ">ເຜົ່າລາວ</option>
                                <option value="ເຜົ່າມົ້ງ">ເຜົ່າມົ້ງ</option>
                                <option value="ເຜົ່າກຶມມຸ">ເຜົ່າກຶມມຸ</option>
                                <option value="ເຜົ່າຜູ້ໄທ">ເຜົ່າຜູ້ໄທ</option>
                                <option value="ເຜົ່າລື້">ເຜົ່າລື້</option>
                                <option value="ເຜົ່າໄທດຳ">ເຜົ່າໄທດຳ</option>
                                <option value="ເຜົ່າໄທແດງ">ເຜົ່າໄທແດງ</option>
